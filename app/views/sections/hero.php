...
?>
<div class="elementor-element elementor-element-90f95a5 e-flex e-con-boxed e-con e-child ltk-editable" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}" style="background-image:<?= $b['bg_image'] ? "url('" . e(img($b['bg_image'])) . "')" : 'none' ?>">
